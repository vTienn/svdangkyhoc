...
<body>
    <div class=>
                  ...
                  <div class="col-12 text-center padding-full">
                  
                    <div class="section-two-title">
                    <h2>Thống Kê Sinh Viên Chưa Đăng Kí Học</h2>
        ...
        <tbody>
            <?php if (isset($data['dulieu']) && mysqli_num_rows($data['dulieu']) > 0) : ?>
                ...
                while ($row = mysqli_fetch_assoc($data['dulieu'])) : ?>
                    <tr data-masv="<?php echo $row['masv']; ?>" >
      ...
      document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('dblclick', function () {
                    ...
                    localStorage.setItem(`notification_${masv}`, 'sent');

                    // Show alert
                    alert('Bạn đã gửi thông báo đến sinh viên thành công.');
                });
            });
