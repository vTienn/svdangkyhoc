          ...
          <div class="col-xl-12">
            <div class="inner-main">
              ...
              <div class="inner-body">
                <form action="http://localhost/svdangkyhoc/timkiemxoattgiaovien_ctrl/timkiem" method="post">
                  <div class="row">
                    <div class="col-6 ">
                ...
                ?>
                        <tr>
                           ...
                           <td>
                                ...
                                <a 
                                href="http://localhost/svdangkyhoc/timkiemxoattgiaovien_ctrl/sua/<?php echo $row['magiaovien'] ?>" 
                                

                                class="btn btn-fix">Sửa</a> 
                                
                                &nbsp;
                                <a href="http://localhost/svdangkyhoc/timkiemxoattgiaovien_ctrl/xoa/<?php echo $row['magiaovien'] ?>" class="btn  btn-fix" onclick="confirms(event,this.href)">Xóa</a>
                           </td>
                        </tr>
                <?php
                        }
