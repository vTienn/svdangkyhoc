...
<body>
        ...
        <div class="section-1">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-head">
                            <h2 class="head-title1">Sửa Thông Tin Giáo Viên</h2>
                            <p class="head-desc">
                            Trang sửa thông tin giáo viên của Trường Đại học Công nghệ Giao thông Vận tải giúp cập nhật và quản lý thông tin sinh viên hiệu quả, đảm bảo dữ liệu chính xác, thuận tiện cho việc tra cứu và theo dõi quá trình học tập.
              </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-7">
                    <form action="http://localhost/svdangkyhoc/timkiemxoattgiaovien_ctrl/suadl" method="post">
                        <div class="row">
        ...
        ?>
                                    ...
                                    <input placeholder="Mã GV" class="form-control" type="text" 
                                    readonly
                                    name="txtmagiaovien" value="<?php echo $row['magiaovien'] ?>" />
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-12">
                                <div class="form-group">
                      ...
                      <option value="Nữ" <?php if($row['gioitinh']=='Nữ') echo 'selected'; ?> >Nữ</option>
                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Họ Tên" class="form-control" type="date" name="txtnamsinh" value="<?php echo $row['namsinh'] ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Họ Tên" class="form-control" type="text" name="txtdiachi" value="<?php echo $row['diachi'] ?>" />
                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Email" class="form-control" type="text" name="txtdienthoai" value="<?php echo $row['dienthoai'] ?>" />
                                </div>
                            </div>
                        </div>
                        <?php
